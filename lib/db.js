...
function getDb() {
  ...
  db.exec(SCHEMA);
  // Migration for databases created before max_msg_length existed.
  try { db.exec("ALTER TABLE projects ADD COLUMN max_msg_length INTEGER NOT NULL DEFAULT 20000"); } catch { /* already exists */ }
  return db;
}
