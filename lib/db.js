...
function getDb() {
  ...
  db.exec(SCHEMA);
  // Migration cho DB tạo trước khi có cột max_msg_length
  try { db.exec("ALTER TABLE projects ADD COLUMN max_msg_length INTEGER NOT NULL DEFAULT 20000"); } catch { /* đã có */ }
  return db;
}
